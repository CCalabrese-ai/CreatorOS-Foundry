...
| **P62-004** | Node runtime below `.nvmrc`/Vite minimum | **Resolved** | Phase 6.6: `fnm` configured, `.nvmrc` auto-switch proven with a genuine override test; this session's own tooling now resolves Node 24 automatically in at least one additional shell context beyond what Phase 6.6 confirmed — see Environment Notes |
